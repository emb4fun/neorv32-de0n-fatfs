...
module qsys_core_mm_interconnect_0 (
	...
	wire    [1:0] rsp_mux_src_channel;                                                 // rsp_mux:src_channel -> wb_avm_bridge_m0_agent:rp_channel
	...
	wire   [31:0] spi_master_s1_agent_m0_address;                                      // spi_master_s1_agent:m0_address -> spi_master_s1_translator:uav_address
	...
	wire  [102:0] spi_master_s1_agent_rf_source_data;                                  // spi_master_s1_agent:rf_source_data -> spi_master_s1_agent_rsp_fifo:in_data
	...
	wire  [102:0] spi_master_s1_agent_rsp_fifo_out_data;                               // spi_master_s1_agent_rsp_fifo:out_data -> spi_master_s1_agent:rf_sink_data
	...
	wire          cmd_mux_001_src_valid;                                               // cmd_mux_001:src_valid -> spi_master_s1_agent:cp_valid
	wire  [101:0] cmd_mux_001_src_data;                                                // cmd_mux_001:src_data -> spi_master_s1_agent:cp_data
	wire          cmd_mux_001_src_ready;                                               // spi_master_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                             // cmd_mux_001:src_channel -> spi_master_s1_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                       // cmd_mux_001:src_startofpacket -> spi_master_s1_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                         // cmd_mux_001:src_endofpacket -> spi_master_s1_agent:cp_endofpacket
	...
	wire          spi_master_s1_agent_rp_valid;                                        // spi_master_s1_agent:rp_valid -> router_002:sink_valid
	wire  [101:0] spi_master_s1_agent_rp_data;                                         // spi_master_s1_agent:rp_data -> router_002:sink_data
	wire          spi_master_s1_agent_rp_ready;                                        // router_002:sink_ready -> spi_master_s1_agent:rp_ready
	wire          spi_master_s1_agent_rp_startofpacket;                                // spi_master_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          spi_master_s1_agent_rp_endofpacket;                                  // spi_master_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire    [1:0] router_001_src_channel;                                              // router_001:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire    [1:0] sdram_s1_rsp_width_adapter_src_channel;                              // sdram_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire    [1:0] cmd_mux_src_channel;                                                 // cmd_mux:src_channel -> sdram_s1_cmd_width_adapter:in_channel
	...
	wire    [1:0] sdram_s1_cmd_width_adapter_src_channel;                              // sdram_s1_cmd_width_adapter:out_channel -> sdram_s1_burst_adapter:sink0_channel
	...
	wire          spi_master_s1_agent_rdata_fifo_src_valid;                            // spi_master_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] spi_master_s1_agent_rdata_fifo_src_data;                             // spi_master_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          spi_master_s1_agent_rdata_fifo_src_ready;                            // avalon_st_adapter_001:in_0_ready -> spi_master_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                   // avalon_st_adapter_001:out_0_valid -> spi_master_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                    // avalon_st_adapter_001:out_0_data -> spi_master_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                   // spi_master_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                   // avalon_st_adapter_001:out_0_error -> spi_master_s1_agent:rdata_fifo_sink_error
	...
	qsys_core_mm_interconnect_0_router_002 router_002 (
	...
	qsys_core_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_sys_clk_clk),                                 //       clk.clk
		.reset               (wb_avm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_core_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_sys_clk_clk),                                 //       clk.clk
		.reset              (wb_avm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_core_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_sys_clk_clk),                                 //       clk.clk
		.reset              (wb_avm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_core_mm_interconnect_0_avalon_st_adapter_001 #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
