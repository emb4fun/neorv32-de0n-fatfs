	qsys_core u0 (
		...
		.spim_cs           (<connected-to-spim_cs>),           //  spim.cs
		.spim_sclk         (<connected-to-spim_sclk>),         //      .sclk
		.spim_mosi         (<connected-to-spim_mosi>),         //      .mosi
		.spim_miso         (<connected-to-spim_miso>),         //      .miso
		.spim_cd           (<connected-to-spim_cd>),           //      .cd
		.spim_wp           (<connected-to-spim_wp>)            //      .wp
	);
